...
<form id="sign-in-providers-form">
	...
	<table class="form-table">
		...
		<tr>
			<th scope="row">
				<label for="email-password"><img height="24" src="<?php echo $args['plugin_url'] . 'assets/mail-logo.svg'; ?>" /> <span class="mail"><?php _e( 'Email/Password', 'sso-firebase' ) ?></span></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="facebook"><img height="24" src="<?php echo $args['plugin_url'] . 'assets/facebook-logo.svg'; ?>" /> <span class="facebook"><?php _e( 'Facebook', 'sso-firebase' ) ?></span></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="google"><img height="24" src="<?php echo $args['plugin_url'] . 'assets/google-logo.svg'; ?>" /> <span class="google"><?php _e( 'Google' ) ?></span></label>
			</th>
			<td>
