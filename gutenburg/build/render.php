	...
	<?php if ( $attributes['showGoogle'] ) : ?>
		<p class="btn-wrapper">
			<button
				...
				type="submit"
			>
				<img width="24" src="<?php echo PLUGIN_URL . 'src/assets/images/google-logo.svg'; ?>" /> Google
			</button>
		</p>
	<?php endif; ?>
	<?php if ( $attributes['showFacebook'] ) : ?>
		<p class="btn-wrapper">
			<button
				...
				type="submit"
			>
				<img width="48" src="<?php echo PLUGIN_URL . 'src/assets/images/facebook-logo.svg'; ?>" /> Facebook
			</button>
		</p>
	<?php endif; ?>
	<?php wp_login_form(); ?>
